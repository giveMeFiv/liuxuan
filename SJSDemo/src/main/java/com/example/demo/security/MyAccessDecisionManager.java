...
public class MyAccessDecisionManager implements AccessDecisionManager{
    ...
    //此方法是为了判定用户请求的Url 是否在权限表中，如果在权限表中，则返回decide方法，用来判定用户是否有此权限，如果不在权限表中则放行。
    ...
    public void decide(
            ...
            Authentication authentication,//是UserDetailsServiceImpl中循环添加到GrantedAuthority 对象中的权限信息集合
    		...
    		System.out.println("我是MyAccessDecisionManager的decide方法"+authentication.getAuthorities());
        ...
        for(Iterator<ConfigAttribute> iter = configAttributes.iterator(); iter.hasNext(); ) {
            ...
            System.out.println(needRole.trim()+"config的值");
