package com.example.demo.springbootlog.aspect;
...
import com.example.demo.springbootlog.annotation.SystemServiceLog;
...
public class SystemLogAspect {
     ...
     */
    @Pointcut("@annotation(com.example.demo.springbootlog.annotation.SystemServiceLog)")
    public void serviceAspect(){}

    /***
     * 定义controller切入点拦截规则，拦截SystemControllerLog注解的方法
     */
    @Pointcut("@annotation(com.example.demo.springbootlog.annotation.SystemControllerLog)")
